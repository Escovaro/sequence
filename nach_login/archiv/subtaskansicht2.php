...
<!-- 1. Row Titel -->
    <div class="container-fluid padding-left">
        <div class="row">
            <div class="col-lg-12">
                <!-- $Projektname -->
                <h1 class="display-8">Subtaskname</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid padding-left">
        <div class="row">
            <!-- VIDEOPLAYER & SCREENSHOT-BUTTON-->
                <div class="col-xl-7">            
                    <video class="embed-responsive embed-responsive-16by9 video-player" controls>
                        <source src="videos/video4_640x480.mp4" type="video/mp4">
                    </video>
                    <br>
    ...
    <div class="container-fluid padding-left">
        <div class="row">
            <div class="col-lg-12 collapse collapseZeichnenToolbar">
                <!-- TOOLBAR -->   
                <div class="wrapper collapse collapseZeichnenToolbar">
                    <div class="toolbar">
