<?php
    ...
    //Setzen Subtask-ID
    $subtaskid = "SELECT subtaskid FROM media WHERE mediaid = $mediaid";
        $resultset = mysqli_query($conn, $subtaskid) or die("database error:". mysqli_error($conn));
                ...
                <div class='col-xl-7'>  
                    <?php    
                        ...
                        //$sbtsktid = $_SESSION['subtaskid'];                           
                            ...
                            $fetchVideos = mysqli_query($conn, "SELECT mediapfad FROM media WHERE mediaid = '".$mediaid."' ");
                    ...
                    <div class="container-fluid subtask-container table-responsive" id= "register">
                        ...
                        <table class="table table-striped w-auto" id="mediatabelle">
                            ...
                            <tr>  
                                ...
                                // 1. Abfrage weitere Media dieser Subtask f. Tabelle: 
                                $sql1 = "";
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-6">
                                <button type="button" class="btn btn-info btn-sm" id="refreshBtn"><i class="fas fa-sync"></i> Synchronisieren </button>
                            </div>
                        </div>                    
                    </div>
                </div>
...
<div class="container-fluid">
        ...
        <div class="row">                        
            <div class="collapse" id="collapseExample">
                    ...
                    ?>
                    <div class="col-lg-6 Projektinfo">
                    ...
                    <p>Screenshotgalerie</p>
                        Anm.: Hier werden nur Screenshots zu DIESER Mediendatei angezeigt!
