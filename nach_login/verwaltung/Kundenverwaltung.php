<?php
    ...
    include_once 'action_kunde.php';
    include_once 'action_projekt.php';
        ...
        $("body").on("click", ".editBtn", function(e){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $("#kundenid").val(data.kundenID);
                    $("#firmenname").val(data.firmenname);
                    $("#kontaktvorname").val(data.kontaktvorname);
                    $("#kontaktnachname").val(data.kontaktnachname);
                    ...
                    $("#plz").val(data.plz);
                    $("#land").val(data.land);
                    $("#branche").val(data.branche);
                    $("#beschreibung").val(data.beschreibung);
                }
            });
        // Kunden-Update (Durchführung)
...
<!-- Seitentitel -->
    <div class="container-fluid padding">
        <div class="row welcome text-center">
            <div class="col-12">
                <h1 class="display-4">kundenverwaltung</h1>
            </div> 
            <hr>
            <div class="col-12">
                <p class="lead"><p>
    ...
    <div class="container-fluid padding-left">
        <div class="row">
            ...
            <div class="container-fluid text-nowrap verwaltungs-container">
                    <br><button type="button" class="customsubmit5 m-1 float-right" data-toggle="modal" data-target="#neuKunde"><i class="fas fa-user-plus fa-sm"></i> Neuen Kunden anlegen</button>
...
<!-- Kunden-Editieren-Modal -->
    <div class="modal fade" id="editMod">
        ...
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
            <h4 class="modal-title">Kunden editieren</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body">
                <form method="post" action="" id="edit-form-data">
                    <!-- ID-Übergabe -->
                    <div class="form-group">
                        <input type="text" class="form-control" name="kundenid" id="kundenid" placeholder="Kundenid" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="firmenname" id="firmenname" placeholder="Firmenname" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="kontaktvorname" id="kontaktvorname" placeholder="Kontaktvorname" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="kontaktnachname" id="kontaktnachname" placeholder="Kontaktnachname" required>
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control" name="email" id="email" placeholder="Email" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="telefon" id="telefon" placeholder="Telefonnr." required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="land" id="land" placeholder="Land" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="branche" id="branche" placeholder="Branche" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="beschreibung" id="beschreibung" placeholder="Beschreibung" required>
                    </div>
                    <div class="form-group">
                        <input type="submit" id="update" name="update" class="btn btn-danger btn-block" value="Kunde updaten" required></button>
                    </div>
                </form>
            </div>
