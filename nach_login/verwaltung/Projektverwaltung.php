...
<!-- Projekt-Editieren-Modal -->
    <div class="modal fade" id="editMod">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title">Projekt editieren</h4>
            ...
            <div class="modal-body">
                <form method="post" action="" id="edit-form-data">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="projektid" id="projektid" placeholder="projektid" required>
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="auftraggeberid" id="auftraggeberid" placeholder="auftraggeberid" required>
                    </div>
