<?php
    ...
    $sql2 = "SELECT position FROM mitarbeiter WHERE mitarbeiterid = $mitarbeiterid";
        ...
        if ($position_ma >= '3'){
            ...
            header("location: subtaskverwaltung_mitarbeiter.php");
        }
?>
...
// Subtasks anzeigen 
        ...
        $("body").on("click", ".editBtn", function(e){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    // $("#erstelldatum").val(data.erstelldatum);
                    $("#typ").val(data.typ);
                    $("#beschreibung").val(data.beschreibung);
                    // $("#auftraggeberid").val(data.auftraggeberid);
                    
                }
            });
            
        // Subtask-Update (Durchführung)
    ...
    // Subtask-Delete
        $("body").on("click", ".deleteBtn", function(e){
                ...
                Swal.fire({
                        title: 'Sicher?',
                        text: "Das lässt sich nicht mehr rückgängig machen - vielleicht schon, aber mühselig ;) !",
                        icon: 'warning',
...
<!-- Seitentitel -->
    <div class="container-fluid padding">
        <div class="row welcome text-center">
            <div class="col-12">
                <h1 class="display-4">subtaskverwaltung</h1>
            </div> 
            <hr>
            <div class="col-12">
                <p class="lead"><p>
...
<!-- Projekt-Editieren-Modal -->
    <div class="modal fade" id="editMod">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title">Proejekt editieren</h4>
            ...
            <div class="modal-body">
                <form method="post" action="" id="edit-form-data">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="subtaskid" id="subtaskid" placeholder="subtaskid" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="titel" id="titel" placeholder="titel" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="typ" id="typ" placeholder="typ" required>
                    </div>
